.class public Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;
.super Lcom/alibaba/mobileim/channel/http/HttpWebTokenCallback;
.source "HttpGetWebTokenCallback.java"
...
.method public constructor <init>(Lcom/alibaba/mobileim/channel/EgoAccount;Ljava/lang/String;Ljava/util/Map;Lcom/alibaba/mobileim/channel/event/IWxCallback;)V
    ...
    .line 18
    iput-object p2, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mUrl:Ljava/lang/String;

    .line 19
    iput-object p3, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mParams:Ljava/util/Map;

    .line 20
    iget-object v0, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mAccount:Lcom/alibaba/mobileim/channel/EgoAccount;
    ...
    .line 23
    iget-object v0, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mParams:Ljava/util/Map;
    ...
    .line 25
    :cond_1
    iget-object v1, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mParams:Ljava/util/Map;
...
.method public execute()[B
    ...
    iget-object v1, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mUrl:Ljava/lang/String;

    iget-object v2, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mParams:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lcom/alibaba/mobileim/channel/http/HttpRequestGet;->execute()[B

    move-result-object v0

    .line 37
    iget-object v1, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mData:[B

    if-eqz v1, :cond_1

    .line 38
    iget-object v0, p0, Lcom/alibaba/mobileim/channel/http/HttpGetWebTokenCallback;->mData:[B
