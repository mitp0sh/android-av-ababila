.class Lcom/google/android/apps/analytics/q;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/apps/analytics/q$a;
    }
.end annotation
...
.field b:Lcom/google/android/apps/analytics/q$a;
...
.method public constructor <init>(Lorg/apache/http/HttpHost;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/analytics/q;-><init>(Lorg/apache/http/HttpHost;Lorg/apache/http/conn/scheme/SocketFactory;)V
...
.method public constructor <init>(Lorg/apache/http/HttpHost;Lorg/apache/http/conn/scheme/SocketFactory;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/analytics/q;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/apps/analytics/q;->d:Z

    iput-object p1, p0, Lcom/google/android/apps/analytics/q;->e:Lorg/apache/http/HttpHost;

    iput-object p2, p0, Lcom/google/android/apps/analytics/q;->f:Lorg/apache/http/conn/scheme/SocketFactory;
...
.method private c()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/q;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/q;->f:Lorg/apache/http/conn/scheme/SocketFactory;
    ...
    iget-object v2, p0, Lcom/google/android/apps/analytics/q;->e:Lorg/apache/http/HttpHost;

    invoke-virtual {v2}, Lorg/apache/http/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/apps/analytics/q;->e:Lorg/apache/http/HttpHost;
    ...
    iget-object v1, p0, Lcom/google/android/apps/analytics/q;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/q;->b:Lcom/google/android/apps/analytics/q$a;

    invoke-interface {v0, v1}, Lcom/google/android/apps/analytics/q$a;->a(Z)V

    iput-boolean v1, p0, Lcom/google/android/apps/analytics/q;->d:Z
    ...
    iget-object v6, p0, Lcom/google/android/apps/analytics/q;->b:Lcom/google/android/apps/analytics/q$a;

    invoke-interface {v6, v1}, Lcom/google/android/apps/analytics/q$a;->a(Z)V
    ...
    iput v0, p0, Lcom/google/android/apps/analytics/q;->c:I

    iget v0, p0, Lcom/google/android/apps/analytics/q;->c:I
    ...
    iget v1, p0, Lcom/google/android/apps/analytics/q;->c:I

    invoke-interface {v0, v1}, Lcom/google/android/apps/analytics/q$a;->a(I)V

    invoke-direct {p0}, Lcom/google/android/apps/analytics/q;->d()V
    ...
    invoke-interface {v0}, Lcom/google/android/apps/analytics/q$a;->a()V
    ...
    :cond_6
    iget-boolean v0, p0, Lcom/google/android/apps/analytics/q;->d:Z
...
.method public a(Lcom/google/android/apps/analytics/q$a;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/apps/analytics/q;->b:Lcom/google/android/apps/analytics/q$a;
...
.method public a(Lorg/apache/http/HttpEntityEnclosingRequest;)V
    ...
    invoke-direct {p0}, Lcom/google/android/apps/analytics/q;->c()V
