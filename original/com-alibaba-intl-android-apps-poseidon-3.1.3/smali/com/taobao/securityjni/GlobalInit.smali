...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput v2, Lcom/taobao/securityjni/f;->a:I
    ...
    const-string v1, "System.loadLibrary(SSECeg-1.2.6)"
...
.method private static AppFilesDirExists(Landroid/content/ContextWrapper;)Lcom/taobao/securityjni/b;
    .locals 6
    ...
    new-instance v2, Lcom/taobao/securityjni/b;

    invoke-direct {v2, v0}, Lcom/taobao/securityjni/b;-><init>(B)V

    iput-boolean v0, v2, Lcom/taobao/securityjni/b;->b:Z
    ...
    iput-boolean v1, v2, Lcom/taobao/securityjni/b;->b:Z
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_1

    :goto_0
    iput-object v0, v2, Lcom/taobao/securityjni/b;->a:Ljava/io/File;
...
.method public static GlobalSecurityInitAsync(Landroid/content/ContextWrapper;)V
    ...
    new-instance v1, Lcom/taobao/securityjni/c;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/taobao/securityjni/c;-><init>(Landroid/content/ContextWrapper;Z)V
...
.method public static GlobalSecurityInitSyncSo(Landroid/content/ContextWrapper;)V
    ...
    invoke-direct {v0, v2}, Lcom/taobao/securityjni/d;-><init>(Z)V
...
.method private static LoadSoFromApk(Landroid/content/ContextWrapper;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lcom/taobao/securityjni/GlobalInit;->AppFilesDirExists(Landroid/content/ContextWrapper;)Lcom/taobao/securityjni/b;

    move-result-object v3

    iget-boolean v4, v3, Lcom/taobao/securityjni/b;->b:Z

    if-eqz v4, :cond_6

    new-instance v4, Ljava/io/File;

    iget-object v3, v3, Lcom/taobao/securityjni/b;->a:Ljava/io/File;

    const-string v5, "libSSECeg-1.2.6.so"
    ...
    const-string v6, "libSSECeg-1.2.6.so"
    ...
    const-string v5, "lib/armeabi/libSSECeg-1.2.6.so"
...
.method private static LoadSoFromAssert(Landroid/content/ContextWrapper;)Z
    ...
    iget-boolean v3, v1, Lcom/taobao/securityjni/b;->b:Z

    if-eqz v3, :cond_0

    iget-object v1, v1, Lcom/taobao/securityjni/b;->a:Ljava/io/File;
    ...
    :cond_1
    const-string v0, "armeabi/libSSECeg-1.2.6.so"
    ...
    const-string v4, "libSSECeg-1.2.6.so"
...
.method private static final VerifySoExistence(Landroid/content/ContextWrapper;)V
    ...
    const-string v2, "/lib/libSSECeg-1.2.6.so"
    ...
    const-string v0, "VerifySoExistence"
    ...
    const-string v3, " :[File Exists Return False]"
...
.method private static delayQueueInit()V
    ...
    invoke-static {}, Lcom/taobao/securityjni/tools/e;->a()V

    new-instance v0, Lcom/taobao/securityjni/b/b;

    invoke-direct {v0}, Lcom/taobao/securityjni/b/b;-><init>()V
