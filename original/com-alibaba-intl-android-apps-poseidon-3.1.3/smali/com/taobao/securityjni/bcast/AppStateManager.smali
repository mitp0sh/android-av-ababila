...
.method public static final SendDNSBroadCast(Landroid/content/Context;II[B)V
    ...
    const-string v1, "setaobao.bbox.DNS"

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "DNSinfolocal"

    invoke-virtual {v0, v1, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v1, "DNSinfonet"
    ...
    const-string v1, "com.setaobao.bbox.permission.APP_STATE"
...
.method public static final SendRTBroadCast(Landroid/content/Context;I)V
    ...
    const-string v1, "setaobao.bbox.RT"

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "RTinfo"
...
.method public static final SendSPITEPBroadCast(Landroid/content/Context;I)V
    ...
    const-string v1, "setaobao.bbox.SPITEP"

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "SPITEPinfo"
